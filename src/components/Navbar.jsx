...
export default function Navbar() {
  return (
    <nav className="site-navbar mt-4">
      <div className="container py-1">
        <div className="row align-items-center">
          <div className="col-8 col-md-8 col-lg-4">
            <h1 className="mb-0"><a href="index.html" className="text-white h2 mb-0"><strong>PropertyHub<span className="text-danger">.</span></strong></a></h1>
          </div>
            ...
            <nav className="site-navigation text-right text-md-right" role="navigation">
              ...
              <ul className="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li className="has-children">
                  ...
                  <Dropdown className="dropdown arrow-top">
